...
[0] = LAYOUT(
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,  KC_B,   KC_MUTE, KC_MPLY, KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_BSPC,
           KC_LCTL, KC_LALT, KC_LGUI, MO(2), KC_BSPC,                  KC_SPC,  MO(1),  KC_RGUI, KC_RALT, KC_RGUI
),

[1] = LAYOUT(
  KC_F1,   KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,                      KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,  KC_F12,
  KC_TRNS, KC_LPRN,  KC_RPRN,  KC_LCBR,  KC_RCBR,  KC_TRNS,                    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS,
  KC_TRNS, KC_GRV,   KC_TRNS,  KC_MINUS, KC_EQUAL, KC_TRNS,                    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS,
...
[2] = LAYOUT(
  ...
  KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,                    KC_PGUP,  KC_HOME,  KC_TRNS,  KC_END,   KC_INS,  KC_DEL,
  KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,                    KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_UP,   KC_TRNS,
